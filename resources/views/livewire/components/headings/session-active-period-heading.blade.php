...
<div class="w-full relative space-y-1">
    <div class="sm:flex sm:flex-row-reverse sm:items-center sm:gap-2">
        <div class="flex-1 sm:flex sm:flex-row-reverse sm:justify-end sm:items-center mb-1 sm:mb-0">
            ...
            <div x-show="!$wire.editing" class="flex items-center gap-2 min-h-10 mt-1 sm:mt-0">
                <div class="flex items-center gap-2">
                    <flux:heading size="lg">{{ $session->active_period }}</flux:heading>
