                    ...
                    <flux:table.row wire:key="{{ $club->id }}">
                        ...
                        <flux:table.cell class="flex justify-end">
                            <flux:dropdown position="bottom" align="end">
                                ...
                                <flux:menu>
                                    <flux:menu.item href="{{ route('club', [$club]) }}" icon="eye" icon-variant="outline" wire:navigate>View</flux:navmenu.item>
                                    <flux:menu.item href="{{ route('club.admin', [$club]) }}" icon="pencil" icon-variant="outline" wire:navigate>Admin</flux:navmenu.item>
                                </flux:navmenu>
                            </flux:dropdown>
                        </flux:table.cell>
                    </flux:table.row>
