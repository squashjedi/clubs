        ...
        <el-dialog>
            <dialog id="sidebar" class="backdrop:bg-transparent lg:hidden">
                ...
                <div tabindex="0" class="fixed inset-0 flex focus:outline-none">
                    <el-dialog-panel
                        class="group/dialog-panel relative flex w-full max-w-xs flex-1 pr-16 transform transition duration-300 ease-in-out data-closed:-translate-x-full"
                    >
                        <div class="absolute top-0 right-0 flex w-16 justify-center pt-5 duration-300 ease-in-out group-data-closed/dialog-panel:opacity-0">
