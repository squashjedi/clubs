...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark h-full bg-white">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800 text-sm">
        ...
        <flux:sidebar sticky collapsible class="bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
            ...
            <x-navlists.club-admin-navlist :$club />
        ...
        <flux:header class="lg:hidden border-b min-h-16 gap-3">
            <flux:sidebar.toggle class="lg:hidden ml-6 lg:ml-8" variant="filled" icon="bars-2" inset="left" class="cursor-pointer" />
            <div class="flex items-center gap-4 py-2">
                <flux:heading size="lg" variant="strong">{{ $club->name }}</flux:heading>
                <flux:button
                    variant="filled"
                    size="sm"
        ...
        <flux:main class="">
            <div class="-mx-6 lg:-mx-8 -mt-8 pt-4 mb-6 hidden lg:block">
                ...
                <div class="flex items-center gap-4 pb-4 px-6 lg:px-8">
                    <flux:heading class="!pb-0" size="lg">{{ $club->name }}</flux:heading>
                    <flux:button
                        variant="filled"
                        size="sm"
                        href="{{ route('club', [$club]) }}"
