<?php
// database/migrations/2025_10_25_042000_drop_opp_competitor_id_from_results.php
...
return new class extends Migration {
    ...
    private const COL = 'opp_competitor_id';
    private const REF_TABLE = 'competitors';
    private const REF_COL = 'id';

    // Names used when recreating in down()
    private const INDEX_NAME = 'results_opp_competitor_id_index';
    private const FK_NAME    = 'results_opp_competitor_id_foreign';
    ...
    public function down(): void
    {
        ...
        // Recreate FK with a predictable name
        Schema::table(self::TABLE, function (Blueprint $table) {
            try {
